...
$sqlHelp = $con->prepare("SELECT nombre, apellido, codigoDirectivo, escuela, codigoEscuela, urlImagen FROM directivo WHERE correo = :correoDirectivo");
$sqlHelp->bindParam(':correoDirectivo', $correoDirectivo, PDO::PARAM_STR);
$sqlHelp->execute();
$directivo = $sqlHelp->fetchAll(PDO::FETCH_ASSOC);
...
<div class="container">
    <h2>Editar Perfil</h2>
    <?php foreach($directivo as $row){ ?>
    <form action="modificarInfoDirectivo.php" method="POST" enctype="multipart/form-data">
          <div class="form-group">
              <label for="imagenPerfil" class="image-upload-label">
                  <div class="image-container">
                      <img src="<?php echo $directivo[0]['urlImagen']; ?>" alt="Perfil" class="profile-img">
                        <div class="overlay">
                            <div class="text">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nombre" name="nombre" value="<?php echo $codigoDirectivo = $directivo[0]['nombre'];?>" required>
        </div>
        <div class="form-group">
            <label for="apellido">Apellido:</label>
            <input type="text" id="apellido" name="apellido" value="<?php echo $codigoDirectivo = $directivo[0]['apellido'];?>" required>
        </div>

        <div class="form-group">
            <label for="escuela">Codigo escuela:</label>
            <input type="text" id="codigoEscuela" name="codigoEscuela" value="<?php echo $codigoDirectivo = $directivo[0]['codigoEscuela'];?>" required>
        </div>
        
        <div class="form-group">
            <label for="escuela">Escuela:</label>
            <input type="text" id="escuela" name="escuela" value="<?php echo $codigoDirectivo = $directivo[0]['escuela'];?>" required>
        </div>
