...
<nav class="navbar navbar-expand-lg" style="padding: 1rem; background-color:#e2c4b6">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      ...
      <a href="../../panelControlDirectivo.php" style="padding: 1rem; background-color:#687483; text-decoration: none; color: inherit;" class="boton">Regresar</a>
...
<main>
  ...
  <select id="selector">
    ...
    <a href="../../../generarPDF/pdfAlumnoOlimpiadaDirectivo.php?codigoAlumno=<?php echo urlencode($codigoAlumno); ?>" target="_blank" class="boton-descarga">Descargar PDF</a>
