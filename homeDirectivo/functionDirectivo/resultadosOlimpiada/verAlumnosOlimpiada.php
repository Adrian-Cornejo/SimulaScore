...
function mostrarExamenesEnProgresoPorProfesor($con, $codigoProfesor) {
    ...
    echo "<h2>Alumnos - Profesor: " . htmlspecialchars($nombreProfesor) . "</h2>";
    ...
    if (!empty($examenesEnProgreso)) {
        ...
        foreach ($examenesEnProgreso as $examen) {
            ...
            echo "<td>";
            echo "<a href='verProgresoAlumnoOlimpiada.php?codigoAlumno=" . urlencode($codigoAlumno) . "'>";
...
<main>
  <div styles="margin 0 15px;"> <h1>Administrar progreso del Alumno en el examen: Olimpiada del Conocimiento </h1></div>
