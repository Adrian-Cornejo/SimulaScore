...
$sqlInsert = $con->prepare("INSERT INTO resultados_examen_mejoredu (codigoAlumno, en_progreso,fecha) VALUES (:codigoAlumno, 1,:fecha)");
...
<h1 style="font-size: 3rem; color:black;">Examen MejorEdu 2022</h1>
  ...
  <?php
  function generarFormularioExamen($nombreTabla, $conexion, $numPreguntas,$numPag) {

    //ORDER BY RAND()
    // Preparar y ejecutar la consulta SQL
    $sqlHelp = $conexion->prepare("SELECT id_pregunta, pregunta, respuesta1, respuesta2, respuesta3, respuesta4, texto_adicional, url_imagen FROM $nombreTabla ORDER BY RAND() LIMIT $numPreguntas");
    $sqlHelp->execute();
...
// enviar todas las respuestas del formulario
  document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('submitAll').addEventListener('click', function() {
        ...
        hiddenForm.action = 'procesarRespuestas.php'; // Ajusta la acción según sea necesario
