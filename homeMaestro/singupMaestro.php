...
<head>
    ...
    <title>Crear cuenta: Maestro</title>
    ...
    <main>
        <div class="contenedor__crearCuenta">
            <div class="login-container">
                ...
                <h1>Crear Cuenta: Maestro</h1>


                <form class="formulario" action="storeMaestro.php" method="post">
                    ...
                    <input type="text" id="codigoDirectivo" placeholder="Codigo directivo" name="codigoDirectivo" value="<?= (!empty($_GET['codigoDirectivo'])) ? $_GET['codigoDirectivo'] : "" ?>">
