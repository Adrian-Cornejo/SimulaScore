...
<main>
    ...
    <a href="javascript:void(0);" id="botonDescargarPDF" class="boton-descarga">Descargar PDF</a>
...
<div id="resultadosUltimo" class="contenido " >
<div class="descripcion">
...
<div id="resultadosGeneral" class="contenido " >
<div class="descripcion">
...
<div id="resultadosMaterias" class="contenido ">
<div class="descripcion">
...
<div id="resultadosEspanol" class="contenido " >
<div class="descripcion">
...
<div id="resultadosMatematicas" class="contenido " >
<div class="descripcion">
...
<div id="resultadosFce" class="contenido " >
<div class="descripcion">
...
<div id="resultadosMateriasGeneral" class="contenido " >
<div class="descripcion">
...
document.getElementById('botonDescargarPDF').addEventListener('click', function(e){
    e.preventDefault(); // Previene la acción por defecto del enlace

    // Supongamos que tienes 2 gráficas como ejemplo
    var imageData1 = graficaPromedioGeneral.toBase64Image();
    var imageData2 = graficaMaterias.toBase64Image();
    ...
    $.ajax({
        type: "POST",
        url: "../../generarPDF/generarPDF.php", // Cambia la URL al script que genera el PDF
        data: {
            graficaPromedioGeneral: imageData1,
            graficaMaterias: imageData2
        },
        success: function(response) {
            console.log("PDF generado correctamente", response);
            // Opcional: abre el PDF generado en una nueva ventana
