...
$sqlHelp = $con->prepare("SELECT nombre, apellido, codigoProfesor, escuela, codigoEscuela, urlImagen FROM profesor WHERE correo = :correoMaestro");
$sqlHelp->bindParam(':correoMaestro', $correoMaestro, PDO::PARAM_STR);
$sqlHelp->execute();
$Maestro = $sqlHelp->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../../build/css/directivos.css"> <!-- Asegúrate de usar la ruta correcta a tu CSS -->
</head>
<body>
...
<nav class="navbar navbar-expand-lg" style="padding: 1rem; background-color:#e2c4b6">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="../panelControlMaestro.php" style="font-size:3rem; padding:0.5rem; margin-left: 15rem;">
      ...
      <a href="../panelControlMaestro.php" class="boton" style="padding: 2rem; background-color:#687483; text-decoration: none; color: inherit;">
        Regresar
      </a>
  </div>
</nav>
...
<div class="container">
    <h2>Editar Perfil</h2>
    <?php foreach($Maestro as $row){ ?>
    <form action="modificarInfoMaestro.php" method="POST" enctype="multipart/form-data">
          <div class="form-group">
              <label for="imagenPerfil" class="image-upload-label">
                  <div class="image-container">
                      <img src="<?php echo $Maestro[0]['urlImagen']; ?>" alt="Perfil" class="profile-img">
                        <div class="overlay">
                            <div class="text">
        ...
        <div class="form-group">
            ...
            <input type="text" id="nombre" name="nombre" value="<?php echo $codigoMaestro = $Maestro[0]['nombre'];?>" required>
        </div>
        <div class="form-group">
            <label for="apellido">Apellido:</label>
            <input type="text" id="apellido" name="apellido" value="<?php echo $codigoMaestro = $Maestro[0]['apellido'];?>" required>
        </div>

        <div class="form-group">
            <label for="escuela">Codigo escuela:</label>
            <input type="text" id="codigoEscuela" name="codigoEscuela" value="<?php echo $codigoMaestro = $Maestro[0]['codigoEscuela'];?>" readonly>
        </div>
        
        <div class="form-group">
            <label for="escuela">Escuela:</label>
            <input type="text" id="escuela" name="escuela" value="<?php echo $codigoMaestro = $Maestro[0]['escuela'];?>" readonly>
        </div>
